...
from assent_run_utils_v4 import *
...
if __name__ == "__main__":
    ...
    from assent_data_v4 import GraphDataset
    from assent_data_utils_v4 import data_loader
    from torch_geometric.loader import DataLoader
    from assent_model_v4 import ASSENTGNN, ASSENTGNN_GAT, ASSENTGNN_Transformer
    import json
    ...
    results = data_loader(nsamps=config['nsamps'])
