...
def plot_losses(history: Dict, out_dir: str, smooth: int = 1, show_plot: bool = True, save_plot: bool = True):
    ...
    Lrf_t = get(history, "train_loss_rf", [])
    Lc_t = get(history, "train_loss_couple", [])
    ...
    Lrf_v = get(history, "val_loss_rf", [])
    Lc_v = get(history, "val_loss_couple", [])
    ...
    items = [
        ...
        ("loss_rf", Lrf_t, Lrf_v, "RF Penalty"),
        ("loss_couple", Lc_t, Lc_v, "Coupling Penalty"),
    ]
...
def plot_f1(history: Dict, out_dir: str, smooth: int = 1, show_plot: bool = True, save_plot: bool = True):
    ...
    f1x = get(history, "val_f1x_u", [])
    f1t = get(history, "val_f1tau_m", [])
    f1s = get(history, "val_f1s_m", [])
...
if __name__ == "__main__":
    ...
    # args = ap.parse_args()
    hist_path = 'checkpoints/2025-10-19-14-51_history.json'
    summary_path = 'checkpoints/2025-10-19-14-51_summary.json'
    out_dir = 'plots'
    smooth = 5
    show_plot = True
    save_plot = False
