...
from src.learning_v1.assent_model import ASSENT, train_epoch, evaluate_model, calculate_utility_score
...
CONSOLE_RUN = False
cwd = os.getcwd()
console_run = cwd + '/src/learning_v1' if CONSOLE_RUN else ''
...
# milp_objective_values = torch.load('milp_objective_values.pt') # Uncomment to load the MILP objective values
...
# Instantiate ASSENT model (from the imported class)
